...
namespace GlobalHotkeyWithDotNET
{
    public class Hotkey : IMessageFilter
	{
		...
		public bool Register(Control windowControl)
        {
			...
			// Register the hotkey
			if (RegisterHotKey(windowControl != null ? windowControl.Handle : IntPtr.Zero, this.id, modifiers, keyCode) == 0)
			{ 
		...
		public void Unregister()
		{
			...
			if (this.windowControl == null || !this.windowControl.IsDisposed)
			{
                ...
                if (UnregisterHotKey(windowControl != null ? windowControl.Handle : IntPtr.Zero, this.id) == 0)
				{ throw new Win32Exception(); }
			}
